...
Tags: CaptainForm, captcha, contact form, drag-and-drop, event registration form, form builder plugin, order form, paypal form, poll, popup subscription form, secured forms, survey
Requires at least: 3.9
Tested up to: 4.5
Stable tag: 1.5.2

Easy to use form builder that requires no coding skills. All types of forms for WordPress are built right from the dashboard. No add-ons required.

== Description ==

> CaptainForm is a WordPress form builder without add-ons, easy to use, providing advanced functionality. It requires no coding skills and it’s ideal for building any type of form right from the dashboard such as: order forms, registration forms, surveys, polls, user-submitted posts and more. CaptainForm is a form builder integrated with many 3rd party apps and payment processors such as Google Drive, SalesForce, ActiveCampaign, Dropbox, PayPal, Authorize.net, Stripe and many more. Customer support and advanced data security are available for all plans, including the free option. This WordPress form builder and survey builder is useful for market research, lead generation, online registration management, payment collection and more.
...
2. The CaptainForm "My Form" section.
3. Building a "Contact & Lead Form".
4. The CaptainForm collection of integrable applications.
5. A part of the publishing screen, highlighting the Lightbox method of posting a form on your website.
6. An example of how the "Quiz" looks inside a web page. 
