<?php
	function mcp_script_enqueue(){
		wp_enqueue_style('boothstrapmincss',get_template_directory_uri().'/css/bootstrap.min.css',array(),'1.0.0','all');
		wp_enqueue_style('bootstrapthememin',get_template_directory_uri().'/css/bootstrap-theme.min.css',array(),'1.0.0','all');
		wp_enqueue_script( 'bootstrapminjs', get_template_directory_uri()."/js/vendor/bootstrap.min.js",array() ,'1.0.0', true );
		...
		wp_enqueue_style('googlefont','https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700', array(),'1.0.0','all');
		wp_enqueue_script( 'jquery123', 'https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js', array(), '1.12.2', false );
	}
